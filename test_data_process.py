...
for i in num_samples_to_verify:
    try:
        ...
        gt_bboxes_original = dataset.get_gtbb(i, rot=0, zoom=1.0)
        ...
        for bbox in gt_bboxes_original:
            # print(bbox.center)
            add_rotated_rectangle(axes[0], bbox.center, bbox.width, bbox.length, bbox.angle)
